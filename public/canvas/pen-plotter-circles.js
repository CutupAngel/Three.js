...
const sketch = ({
  ...
  let lines = []; // Draw some circles expanding outward
  ...
  lines = clipPolylinesToBox(lines, box); // The 'penplot' util includes a utility to render
